...
var partial$0 = require('./partial.hbs');
HandlebarsCompiler.registerPartial('./partial.hbs', partial$0);
...
},{"./partial.hbs":25,"hbsfy/runtime":24}],2:[function(require,module,exports){
...
},{"./custom.hbs":1,"./div":2,"./mult":4,"./sub":26,"./sum":27,"hbsfy/runtime":24}],4:[function(require,module,exports){
module.exports = (n1, n2) => {
  return n1 * n2;
};
...
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<h2>This is a partials</h2>\n";
},"useData":true});
